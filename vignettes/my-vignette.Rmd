...
```{r inheritance, message=FALSE, results="hide"}
penn_inheritance <- 
...
All CNVs from an offspring (not only the de novo) can be visualized in the raw 
data using the function `lrr_trio_plot`. A simpler function to visualize one single 
event without any focus on family relations will be implemented soon.    
