...
purpose and useful for any CNVs study. The typical main steps of such analysis using 
CNVgears are:
...
penn <- read_results(DT_path = system.file("extdata", "chrs_14_22_cnvs_penn.txt", 
                     ...
                     sample_list = cohort, markers = SNP_markers, method_ID = "P")
...
quanti <- read_results(DT_path = system.file("extdata", "chrs_14_22_cnvs_quanti.txt", 
                      ...
                      chr_col = "chr", start_col = "posStart", end_col = "posEnd",
                      CN_col = "CN", samp_ID_col = "Sample_ID",
                      sample_list = cohort, markers = SNP_markers, method_ID = "Q")
...
ipn <-  read_results(DT_path = system.file("extdata", "chrs_14_22_cnvs_ipn.txt", 
                     ...
                     chr_col = "chr", start_col = "posStart", end_col = "posEnd",
                     CN_col = "CN", samp_ID_col = "Sample_ID",
                     sample_list = cohort, markers = SNP_markers, method_ID = "I")
...
file.remove(c(file.path("tmp_raw","NA12878.txt"), file.path("tmp_raw/NA12891.txt"), 
...
```{r filtering}
penn_filtered <- cleaning_filter(results = penn, min_NP = 10)
...
We also provide a method to compute Copy Number Variable Regions, starting from 
the integrated object created in the previous step 
...
candidates. We use as an example the two calls detected by both PennCNV and QantiSNP.
